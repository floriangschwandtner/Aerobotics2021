...
Abschließend will das folgende Kapitel\todo{will das folgende Kapitel => soll der folgende Abschnitt} noch einen kurzen 
...
beispielsweiße im Bereich der Anstellwinkelschwingung geflogen werden. \todo{Erklärung zu Frequenzverläufen an Anfang 
stellen?}Aus dem \textit{Newton-Raphson}-Algorithmus erhält man 
...
\todo[inline]{Seitenbewegung erwähnen}