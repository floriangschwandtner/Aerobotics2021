...
u_test(602:1201,1) = 0.05 *sin(time(602:1201)*f_2*2*pi)+eta0;
u_test(1202:1801,1) = 0.05 * sin(time(1202:1801)*f_3*2*pi)+eta0;
...
x_test(602:1201,1) = 0.02 *sin((time(602:1201)+0.5*(1/f_2*ones(600,1)))*f_2*2*pi)+alpha0;
x_test(1202:1801,1) = 0.0001 * sin((time(1202:1801)+0.5*(1/f_3*ones(600,1)))*f_3*2*pi)+alpha0;
...
x_test(602:1201,2) = 0.3 *sin((time(602:1201)+0.5*(1/f_2*ones(600,1)))*f_2*2*pi)+q0;
x_test(1202:1801,2) = 0.01 * sin((time(1202:1801)+0.5*(1/f_3*ones(600,1)))*f_3*2*pi)+q0;
...
x_test(602:1201,3) = 3 *sin((time(602:1201)+0.5*(f_2*ones(600,1)))*f_2*2*pi)+V0;
x_test(1202:1801,3) = 0.1 * sin((time(1202:1801)+0.5*(1/f_3*ones(600,1)))*f_3*2*pi)+V0;
...
x_test(602:1201,4) = 0.02 *sin((time(602:1201)+0.5*(1/f_2*ones(600,1)))*f_2*2*pi)+gamma0;
x_test(1202:1801,4) = 0.0001 * sin((time(1202:1801)+0.5*(1/f_3*ones(600,1)))*f_3*2*pi)+gamma0;
...
t_end = 5000;
[x_Fourier_test, u_Fourier_test, G, f] = FourierTrafo(x_test(1:t_end,:), u_test(1:t_end,:), time(1:t_end));
